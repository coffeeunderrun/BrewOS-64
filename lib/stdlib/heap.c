...
get_first_block(void);

static block_header_t*
find_best_fit(size_t size);

static block_header_t*
expand_block(block_header_t* blk, size_t size);

static block_header_t*
shrink_block(block_header_t* blk, size_t size);

static void
defrag_blocks(block_header_t* blk);

static inline block_header_t*
get_block_head(void* addr);

static inline void*
get_block_data(block_header_t* blk);
